...
const { createUser, readUser, updateUser, deleteUser, loginUser, readProfileUser, listHelpSocialsToken, listForumToken } = require("../controller/user.controller");
...
/* Ruta para listar las publicaciones de un usuario en la ayuda social */
api.get('/socialHelp-user', [
    validateJWT,
    validateParams
], listHelpSocialsToken)

/* Ruta para listar las publicaciones de un usuario en el foro */
api.get('/forumPost-user',[
    validateJWT,
    validateParams
], listForumToken)
